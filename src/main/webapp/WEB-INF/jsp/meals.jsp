...
<div class="jumbotron pt-4" id="meal">
    <div class="container">
        <h3 class="text-center"><spring:message code="meal.title"/></h3>
        <br>
        <section>
            <form class="filterForm" name="filterForm" action="GET">
                <table class="table table-bordered">
                    <thead>
                    <tr>
                        <th><label for="startDate"><spring:message code="meal.startDate"/>:</label></th>
                        <th><label for="endDate"><spring:message code="meal.endDate"/>:</label></th>
                        <th><label for="startTime"><spring:message code="meal.startTime"/>:</label></th>
                        <th><label for="endTime"><spring:message code="meal.endTime"/>:</label></th>
                    </tr>
                    </thead>
                    <tr>
            ...
            <div class="pull-right">
                <button class="btn btn-danger mr-1" onclick="clearForm()">
                    <span class="fa fa-plus"></span>
