...
public class MealTestData {
    ...
    public static Meal getNotValidMeal() {
        return new Meal(MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "", 1);
    }

    public static Meal getNewMealWithNotValidData() {
        return new Meal(null, LocalDateTime.now(), "", 1);
    }
}
