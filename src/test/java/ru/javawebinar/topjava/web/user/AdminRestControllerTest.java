...
class AdminRestControllerTest extends AbstractControllerTest {
    ...
    void updateWithInvalidData() throws Exception {
        User notValidUpdated = getUpdatedWithNotValidData();
        perform(MockMvcRequestBuilders.put(REST_URL + USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(admin))
                .content(jsonWithPassword(notValidUpdated, notValidUpdated.getPassword())))
                .andExpect(status().isUnprocessableEntity());
    ...
    void createWithInvalidData() throws Exception {
        User newUser = getNewWithNotValidData();
    ...
    void createWithDuplicateEmail() throws Exception {
        User user = new User(null, "name", "admin@gmail.com", "password", 2000, Role.USER);
        ...
        assertTrue(content.contains(ErrorType.VALIDATION_ERROR.toString()));
    }
}